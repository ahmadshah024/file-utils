...
# print(fu.file_statistics.get_file_size('shah.txt'))
# print(fu.file_statistics.count_lines('shah.txt'))
# print(fu.file_statistics.calculate_word_frequency('shah.txt'))
